...
public class d_exercise_h_c_logTRXhigh extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_h_c_logTRXhigh() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.enterText(0, "trx");
        solo.clickOnText(java.util.regex.Pattern.quote("TRX"));

        solo.clearEditText((android.widget.EditText) solo.getView("start_date"));
        solo.setDatePicker(0, 2015, 7, 16);
        solo.clickOnView(solo.getView(android.R.id.button1));

        solo.clickOnView(solo.getView("start_time"));

        solo.setTimePicker(0, 2, 15);
        ...
        solo.setProgressBar((android.widget.ProgressBar) solo.getView("range"), 87);
