...
public class d_exercise_m_a_cleanUpCuesOff extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_m_a_cleanUpCuesOff() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnView(solo.getView("voice_cue_toggle"));
