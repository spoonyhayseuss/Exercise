...
public class d_exercise_c_d_typeNotInDB extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_c_d_typeNotInDB() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.enterText(0, "bird watching");
