...
public class d_exercise_g_b_caloriesEstimated extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_g_b_caloriesEstimated() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.setProgressBar((android.widget.ProgressBar) solo.getView("range"), 99);
        solo.setProgressBar((android.widget.ProgressBar) solo.getView("range"), 01);
