...
public class d_exercise_h_i_logViewYogaDelete extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_h_i_logViewYogaDelete() throws ClassNotFoundException {
