...
public class d_exercise_c_a_typeSearchRun extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_c_a_typeSearchRun() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.enterText(0, "ellip");

        solo.clickOnText(java.util.regex.Pattern.quote("Elliptical"));
