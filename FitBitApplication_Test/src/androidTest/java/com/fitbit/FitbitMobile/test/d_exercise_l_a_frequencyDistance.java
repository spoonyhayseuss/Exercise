...
public class d_exercise_l_a_frequencyDistance extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_l_a_frequencyDistance() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.clickOnView(solo.getView("frequency_type"));
        //Click on miles
        solo.clickOnView(solo.getView(android.R.id.text1));

        solo.clickOnView(solo.getView("frequency"));
