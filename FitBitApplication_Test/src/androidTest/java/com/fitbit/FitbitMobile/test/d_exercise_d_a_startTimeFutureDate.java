...
public class d_exercise_d_a_startTimeFutureDate extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public d_exercise_d_a_startTimeFutureDate() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        solo.setDatePicker(0, 2016, 6, 7);
        solo.clickOnView(solo.getView(android.R.id.button1));

        //Assert that: 'The time and duration specified is in the future' is shown
        assertTrue("'The time and duration specified is in the future' is not shown!",
                solo.waitForView(solo.getView(android.R.id.message)));
